import GraciasMobile from '@/components/diagnostico/GraciasMobile'
...
export default function GraciasPage() {
  return (
    <>
      ...
      <div className="only-desktop" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 56, fontFamily: "'Red Hat Display', sans-serif", background: 'var(--bg)' }}>

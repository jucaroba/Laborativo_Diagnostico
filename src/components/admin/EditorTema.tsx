    ...
    <tr style={{ borderBottom: '1px solid var(--line-soft)' }} className="revision-row">
      ...
      <td style={{ width: 64, textAlign: 'right', verticalAlign: 'middle' }}>
        {editando
          ...
          : <span className="row-actions" style={{ display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
              <button onClick={() => { setDraft(texto); setEditando(true) }} style={iconBtn}><Pencil size={15} strokeWidth={2.25} color="var(--ink)" /></button>
